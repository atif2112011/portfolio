...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1REKCZEvRtSK40VqWzzRlaP7GzkueYIn-/view?usp=sharing", // Set to empty to hide the button
...
const bigProjects = {
  ...
  projects: [
    ...
    {
      image: require("./assets/images/project6_1.jpg"),
